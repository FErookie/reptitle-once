...
const base = 'http://aaschool.dlut.edu.cn';
const firstPage = '/index/xwgg/gg.htm'; //新闻首页
        ...
        request
            ...
            .end((err, res) => {
                if (err) {
                    ...
                    let $ = cheerio.load(res.text);
                    let value = {};
                    value.title = $('div#showTitle');
                    value.dateStr = $('div#showTime > span')[2];
                    value.from = $('div#showTime > span')[0] + $('div#showTime > span')[1];
                    value.url = data.url;
                    value.time = new Date();
